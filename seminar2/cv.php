...
$experience = [
    ["name" => "Front End Developer", "date" => "Jan 2015 - ", "description" => "Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est
                        reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure,
                        iste."], 
    ["name" => "Web Developer / something.com", "date" => "Mar 2012 - Dec 2014", "description" => "Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est
                        reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure,
                        iste."],
    ["name" => "Graphic Designer / designsomething.com", "date" => "Jun 2010 - Mar 2012", "description" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit."]
];
                ...
                <div class="w3-container">
                    ...
                    <?php foreach($skills as $key => $skill):?>
                        <p><?=$skill["name"]?>
                            <?php if ($key==0): ?>
                                <span
                                    class="w3-tag w3-teal w3-round">Main
                                </span>
                            <?php endif; ?>
                        </p>
        ...
        <div class="w3-twothird">
            ...
            <div class="w3-container w3-card w3-white w3-margin-bottom">
                <h2 class="w3-text-grey w3-padding-16"><i
                            class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Experience</h2>
                
                <?php foreach($experience as $key => $exp):?>
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b><?=$exp["name"]?></b></h5>
                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$exp["date"]?>
                            <?php if ($key==0): ?>
                                <span
                                    class="w3-tag w3-teal w3-round">Current
                                </span>
                            <?php endif; ?>
                        </h6>
                        <p><?=$exp["description"]?></p>
